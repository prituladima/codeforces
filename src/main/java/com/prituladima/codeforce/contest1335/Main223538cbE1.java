...
public class Main223538cbE1 {
    ...
    private void solve() {
        ...
        int[][] maxCenter = new int[n+20][n+20];
        int[][] maxSides = new int[n+20][n+20];
...
//                if (i <= j) {
                ...
                for (int CHAR1 = 1; CHAR1 <= 26; CHAR1++) {
//                    for (int CHAR2 = 1; CHAR2 <= 26; CHAR2++) {
                        //i == 2 && j == 5 && CHAR1 == 1 && CHAR2 == 2
    //                    if (CHAR1 != CHAR2) {
                            int sides = 2 * Integer.min(
                                    0 < i ? pref[i - 1][CHAR1] : 0,
                                    j < n - 1 ? pref[n - 1][CHAR1] - pref[j][CHAR1] : 0);
                            int center = pref[j][CHAR1] - (0 < i ? pref[i - 1][CHAR1] : 0);

                            //ans = max(ans, sides + center);
                            maxSides[i][j] = max(maxSides[i][j], sides);
                            maxCenter[i][j] = max(maxCenter[i][j], center);
...
//                                        0 < i ? pref[i - 1][CHAR1] : 0,
//                                        j < n - 1 ? pref[n - 1][CHAR1] - pref[j][CHAR1] : 0);
//                                int center = pref[j][CHAR2] - (0 < i ? pref[i - 1][CHAR2] : 0);
                                ans = max(ans, maxSides[i][j] + maxCenter[i][j]);
//                            }
//                        }
//                    }
