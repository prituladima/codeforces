...
public class Pro60 {
    ...
    private void solve() {
        ...
        int newA = Integer.parseInt(String.valueOf(a).replaceAll("0", ""));
        int newB = Integer.parseInt(String.valueOf(b).replaceAll("0", ""));
        int newS = Integer.parseInt(String.valueOf(a + b).replaceAll("0", ""));
        sout(newS == newA + newB ? "YES" : "NO");
