package com.prituladima.google;
...
public final class FibRecursion {
    ...
    private int fib(int n, int deep) {
        soutnl(tab(deep) + "call fib for = " + n);
        i++;
        if (n == 0) {
            return 0;
    ...
    private String tab(int len) {
        ...
        Arrays.fill(chars, '\t');
        return "Level " + len + "->" + String.copyValueOf(chars);
    }


    public static void main(String[] args) {
        new FibRecursion().run();
    }
