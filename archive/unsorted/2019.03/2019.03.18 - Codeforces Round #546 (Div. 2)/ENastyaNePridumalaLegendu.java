...
public class ENastyaNePridumalaLegendu {
    int n, m, q, ans;
    long[] a, b, prefK, k, arrayAns;
    long L, R;
    String s;
    char[] chars;
    ...
    public void solve(int testNumber, InputReader in, OutputWriter out) {
        ...
        SegmentTreeImpl segmentTree = new SegmentTreeImpl(b);
        SegmentTreeImpl segmentTree2 = new SegmentTreeImpl(prefK);
